...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="doc_name" required maxlength="150" class="form-control"
               value="{{ old('doc_name',$item->doc_name??'') }}">
    </div>
    <div class="col-md-2">
        ...
        <input type="text" name="doc_code" required maxlength="50" class="form-control"
               value="{{ old('doc_code',$item->doc_code??'') }}" {{ isset($item)?'readonly':'' }}>
    </div>
    <div class="col-md-1">
...
<div class="row g-2 mb-3">
    <div class="col-md-9">
        <textarea id="smp-ta" class="form-control font-monospace"
                  ...
                  oninput="document.getElementById('smp-hid').value=this.value">{{ $existingSample }}</textarea>
        <input type="hidden" name="sample_context_json" id="smp-hid" value="{{ $existingSample }}">
    </div>
...
<div id="raw-wrap" class="mt-2 d-none">
    <textarea id="raw-ed" class="form-control font-monospace mt-1"
              ...
              oninput="syncFromRaw()">{{ $existingSchema }}</textarea>
</div>
<input type="hidden" name="form_schema" id="fs-hid" value="{{ $existingSchema }}">

<hr>
<div class="d-flex justify-content-end gap-2">
    <a href="{{ route('master.document-type.index') }}" class="btn btn-light">Batal</a>
