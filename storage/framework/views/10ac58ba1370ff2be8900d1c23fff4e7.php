<?php $__env->startSection('title', 'Org Unit'); ?>
<?php $__env->startSection('master_content'); ?>
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0"><i class="bi bi-diagram-3"></i> Org Unit</h5>
    <a href="<?php echo e(route('master.org-unit.create')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Tambah</a>
</div>
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover align-middle">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><code><?php echo e($item->org_code); ?></code></td>
                    <td><?php echo e($item->org_name); ?></td>
                    <td class="text-muted"><?php echo e(optional($item->parent)->org_code); ?></td>
                    ...
                    <td class="text-end">
                        <a href="<?php echo e(route('master.org-unit.edit', $item->idtblorg_unit)); ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                        <form method="POST" action="<?php echo e(route('master.org-unit.destroy', $item->idtblorg_unit)); ?>"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/approval_center/resources/views/master/org_unit/index.blade.php ENDPATH**/ ?>