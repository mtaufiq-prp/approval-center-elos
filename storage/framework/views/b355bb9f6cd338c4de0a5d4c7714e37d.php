<?php $__env->startSection('title', 'Edit Approval Group'); ?>
<?php $__env->startSection('master_content'); ?>
<h5 class="mb-3"><i class="bi bi-people-fill"></i> Approval Group: <?php echo e($item->group_code); ?></h5>

<div class="card shadow-sm mb-3">
    <div class="card-header bg-light small fw-semibold">Detail Group</div>
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('master.approval-group.update', $item->idtblapproval_group)); ?>">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="group_code" required maxlength="50" class="form-control"
                           value="<?php echo e(old('group_code', $item->group_code)); ?>" readonly>
                </div>
                <div class="col-md-8">
                    <label class="form-label">Group Name <span class="text-danger">*</span></label>
                    <input type="text" name="group_name" required maxlength="150" class="form-control"
                           value="<?php echo e(old('group_name', $item->group_name)); ?>">
                </div>
                <div class="col-12">
...
<div class="card shadow-sm">
    <div class="card-header bg-light small fw-semibold">Member Group (<?php echo e($members->count()); ?>)</div>
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('master.approval-group.add-member', $item->idtblapproval_group)); ?>" class="row g-2 mb-3">
            <?php echo csrf_field(); ?>
            <div class="col-md-7">
                <select name="idtbluser" class="form-select form-select-sm" required>
                    ...
                    <?php $__currentLoopData = $availableUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($u->idtbluser); ?>"><?php echo e($u->user_ref); ?> — <?php echo e($u->full_name); ?></option>
        ...
        <div class="table-responsive">
            <table class="table table-sm align-middle">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><code><?php echo e(optional($m->user)->user_ref); ?></code></td>
                        <td><?php echo e(optional($m->user)->full_name); ?></td>
                        <td><?php echo e($m->priority_no); ?></td>
                        <td class="text-end">
                            <form method="POST"
                                  action="<?php echo e(route('master.approval-group.remove-member', [$item->idtblapproval_group, $m->idtblapproval_group_member])); ?>"
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <tr><td colspan="4" class="text-center text-muted py-3">Group belum punya member.</td></tr> <?php endif; ?>
                </tbody>
            </table>
        </div>
    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/approval_center/resources/views/master/approval_group/edit.blade.php ENDPATH**/ ?>