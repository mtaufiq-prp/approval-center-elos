...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h5 class="mb-0"><i class="bi bi-briefcase"></i> Position</h5>
    <a href="<?php echo e(route('master.position.create')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Tambah</a>
</div>
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover align-middle">
            <thead class="table-light small"><tr>
                <th>Code</th><th>Name</th><th>Level</th><th>Org</th><th>Status</th><th class="text-end">Aksi</th>
            </tr></thead>
            <tbody class="small">
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><code><?php echo e($item->position_code); ?></code></td>
                    <td><?php echo e($item->position_name); ?></td>
                    <td class="text-muted"><?php echo e($item->level_no); ?></td>
                    ...
                    <td class="text-end">
                        <a href="<?php echo e(route('master.position.edit', $item->idtblposition)); ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                        <form method="POST" action="<?php echo e(route('master.position.destroy', $item->idtblposition)); ?>"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/approval_center/resources/views/master/position/index.blade.php ENDPATH**/ ?>