...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?php echo e(route('master.document-type.create')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Tambah</a>
</div>
<div class="card shadow-sm"><div class="card-body">
    <form method="GET" class="row g-2 mb-3">
        <div class="col-md-4"><input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control form-control-sm" placeholder="Cari..."></div>
        ...
        <table class="table table-sm table-hover align-middle">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><code><?php echo e($item->doc_code); ?></code></td>
                    ...
                    <td class="text-end">
                        <a href="<?php echo e(route('master.document-type.edit', $item->idtbldocument_type)); ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                        <form method="POST" action="<?php echo e(route('master.document-type.destroy', $item->idtbldocument_type)); ?>"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/approval_center/resources/views/master/document_type/index.blade.php ENDPATH**/ ?>